...
use crate::{Ed25519Blake2b512, Error};
...
pub fn repair_share_step_2(deltas_j: &[Scalar]) -> Scalar {
    frost::keys::repairable::repair_share_step_2::<Ed25519Blake2b512>(deltas_j)
}
...
mod tests {
    ...
    fn check_repair_share_step_1() {
        ...
        frost_core::tests::repairable::check_repair_share_step_1::<Ed25519Blake2b512, _>(rng);
    }
    ...
    fn check_repair_share_step_3() {
        let rng = rand::rngs::OsRng;
        frost_core::tests::repairable::check_repair_share_step_3::<Ed25519Blake2b512, _>(
            rng,
            &REPAIR_SHARE,
        );
    }
