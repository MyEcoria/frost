...
/// An error.
pub type Error = frost_core::Error<Ed25519Blake2b512>;

/// An implementation of the FROST(Ed25519, Blake2b-512) ciphersuite scalar field.
#[derive(Clone, Copy)]
...
/// An implementation of the FROST(Ed25519, Blake2b-512) ciphersuite group.
...
const CONTEXT_STRING: &str = "FROST-ED25519-BLAKE2B512-v1";

/// An implementation of the FROST(Ed25519, Blake2b-512) ciphersuite.
#[derive(Clone, Copy, PartialEq, Eq, Debug)]
pub struct Ed25519Blake2b512;

impl Ciphersuite for Ed25519Blake2b512 {
    ...
    /// H1 for FROST(Ed25519, Blake2b-512)
    ///
    ...
    /// H2 for FROST(Ed25519, Blake2b-512)
    ///
    ...
    /// H3 for FROST(Ed25519, Blake2b-512)
    ///
    ...
    /// H4 for FROST(Ed25519, Blake2b-512)
    ///
    ...
    /// H5 for FROST(Ed25519, Blake2b-512)
    ///
...
pub mod keys {
    ...
    /// # Security
    ///
    /// To derive a FROST(Ed25519, Blake2b-512) keypair, the receiver of the [`SecretShare`] *must* call
    ...
    /// A FROST(Ed25519, Blake2b-512) keypair, which can be generated either by a trusted dealer or using
    /// a DKG.
    ///
...
/// FROST(Ed25519, Blake2b-512) Round 1 functionality and types.
pub mod round1 {
    use crate::keys::SigningShare;

    use super::*;

    /// Comprised of FROST(Ed25519, Blake2b-512) hiding and binding nonces.
    ///
...
/// FROST(Ed25519, Blake2b-512) Round 2 functionality and types, for signature share generation.
pub mod round2 {
    use super::*;

    /// A FROST(Ed25519, Blake2b-512) participant's signature share, which the Coordinator will aggregate with all other signer's
...
/// A Schnorr signature on FROST(Ed25519, Blake2b-512).
pub type Signature = frost_core::Signature<E>;

/// Verifies each FROST(Ed25519, Blake2b-512) participant's signature share, and if all are valid,
...
/// A signing key for a Schnorr signature on FROST(Ed25519, Blake2b-512).
pub type SigningKey = frost_core::SigningKey<E>;

/// A valid verifying key for Schnorr signatures on FROST(Ed25519, Blake2b-512).
