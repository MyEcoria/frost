...
fn check_serialize_vss_commitment() {
    ...
    frost_core::tests::vss_commitment::check_serialize_vss_commitment::<Ed25519Blake2b512, _>(rng);
}

#[test]
fn check_serialize_whole_vss_commitment() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_serialize_whole_vss_commitment::<Ed25519Blake2b512, _>(
        rng,
    );
}
...
fn check_deserialize_whole_vss_commitment() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_deserialize_whole_vss_commitment::<Ed25519Blake2b512, _>(
        rng,
    );
}
...
fn check_deserialize_vss_commitment_error() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_deserialize_vss_commitment_error::<Ed25519Blake2b512, _>(
        rng, &ELEMENTS,
    );
}
