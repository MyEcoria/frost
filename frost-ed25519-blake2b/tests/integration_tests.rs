...
fn check_zero_key_fails() {
    frost_core::tests::ciphersuite_generic::check_zero_key_fails::<Ed25519Blake2b512>();
}
...
fn check_sign_with_dkg() {
    ...
    frost_core::tests::ciphersuite_generic::check_sign_with_dkg::<Ed25519Blake2b512, _>(rng);
}
...
fn check_dkg_part1_fails_with_min_signers_greater_than_max() {
    ...
    let min_signers = 3;
    let max_signers = 2;
    let error: frost_core::Error<Ed25519Blake2b512> = Error::InvalidMinSigners;
...
fn check_rts() {
    ...
    frost_core::tests::repairable::check_rts::<Ed25519Blake2b512, _>(rng);
}
...
fn check_refresh_shares_with_dealer() {
    ...
    frost_core::tests::refresh::check_refresh_shares_with_dealer::<Ed25519Blake2b512, _>(rng);
}
...
fn check_refresh_shares_with_dealer_fails_with_unequal_num_identifiers_and_max_signers() {
    ...
    let min_signers = 2;
    let max_signers = 3;
    let error: frost_core::Error<Ed25519Blake2b512> = Error::IncorrectNumberOfIdentifiers;
...
fn check_refresh_shares_with_dkg() {
    ...
    frost_core::tests::refresh::check_refresh_shares_with_dkg::<Ed25519Blake2b512, _>(rng);
}
...
fn check_sign_with_dealer() {
    ...
    frost_core::tests::ciphersuite_generic::check_sign_with_dealer::<Ed25519Blake2b512, _>(rng);
}
...
fn check_share_generation_ed25519_sha512() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::ciphersuite_generic::check_share_generation::<Ed25519Blake2b512, _>(rng);
}
...
//     frost_core::tests::vectors::check_sign_with_test_vectors::<Ed25519Blake2b512>(&VECTORS);
// }

// #[test]
// fn check_sign_with_test_vectors_dkg() {
//     frost_core::tests::vectors_dkg::check_dkg_keygen::<Ed25519Blake2b512>(&VECTORS_DKG);
// }

// #[test]
// fn check_sign_with_test_vectors_with_big_identifiers() {
//     frost_core::tests::vectors::check_sign_with_test_vectors::<Ed25519Blake2b512>(
...
fn check_error_culprit() {
    frost_core::tests::ciphersuite_generic::check_error_culprit::<Ed25519Blake2b512>();
}

#[test]
fn check_identifier_derivation() {
    frost_core::tests::ciphersuite_generic::check_identifier_derivation::<Ed25519Blake2b512>();
}
...
async fn check_async_sign_with_dealer() {
    tokio::spawn(async {
        let rng = rand::rngs::OsRng;
        frost_core::tests::ciphersuite_generic::async_check_sign::<Ed25519Blake2b512, _>(rng).await;
    })
    .await
    .unwrap();
}
